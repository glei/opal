...
/* enable plugin supporting H.263 via patched FFMPEG */
/* #undef HAVE_H263 */
...
#define LIBAVCODEC_LIB_NAME ""

/* Filename of the libavcodec library */
#define LIBAVUTIL_LIB_NAME ""
