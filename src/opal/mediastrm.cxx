 ...
 * $Revision: 26401 $
 * $Author: rjongbloed $
 * $Date: 2011-09-12 10:57:52 +0900 (月, 12 9 2011) $
 */
...
// PTRACE(1, "Media\tRTP SetMarker...................."<<marker);
...
PBoolean OpalMediaStream::SetDataSize(PINDEX dataSize, PINDEX /*frameTime*/)
{
  if (dataSize <= 0)
    return false;
  PTRACE(2,  "Media\tSet data size from " << dataSize);
...
{
	// PTRACE(1, "start Media\tCould not set colour format in grabber to " << dataSize);
...
// PTRACE(1, "end Media\tCould not set colour format in grabber to " << dataSize);
