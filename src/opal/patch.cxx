 ...
 * $Revision: 26089 $
 * $Author: rjongbloed $
 * $Date: 2011-06-28 16:14:34 +0900 (火, 28 6 2011) $
 */
...
OpalMediaPatch::~OpalMediaPatch()
{
  ...
  inUse.StartWrite();
  if (patchThread != NULL) {
	// kou update 100000->200000 start
    PAssert(patchThread->WaitForTermination(20000), "Media patch thread not terminated.");
	// kou update 100000->200000 end
    delete patchThread;
    patchThread = NULL;
  }
...
PBoolean OpalMediaPatch::AddSink(const OpalMediaStreamPtr & sinkStream)
{
  ...
  PTRACE(5, "Patch\tAddSink\n"
    ...
    // PTRACE(1, "Patch\tAddSinkUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU1");
  if (sourceFormat == destinationFormat) {
    ...
    // PTRACE(1, "Patch\tUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU2");
  ...
  sink->primaryCodec = OpalTranscoder::Create(sourceFormat, destinationFormat, (const BYTE *)id, id.GetLength());
    // PTRACE(1, "Patch\tUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU3");
...
// PTRACE(1, "Patch\tThread ended because source read failedXXXXXXXXXXXXXXXXXXXXXXXXXXXX %d "<<source.GetDataSize());
...
#endif
// kou update start 2012.03.19
    // static const unsigned ThresholdPercent = 90;
    static const unsigned ThresholdPercent = 88;
// kou update end 2012.03.19
