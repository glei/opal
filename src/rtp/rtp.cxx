...
#define RTP_VIDEO_RX_BUFFER_SIZE 0x100000 // 1Mb 0x100000->0x200000
...
// 2012.04.17 kou add start
	if (frame.GetMarker()){
		// PTRACE(m_outOfOrderPackets.empty() ? 1 : 1,"1111111111111111111111111111111111");	
		m_outOfOrderPackets.clear();
		it  = m_outOfOrderPackets.begin();
		m_outOfOrderPackets.insert(it, frame);
	}else{
		m_outOfOrderPackets.insert(it, frame);
	}

// 2012.04.17 kou add end
  // m_outOfOrderPackets.insert(it, frame);
  frame.MakeUnique();
}
