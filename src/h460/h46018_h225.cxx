...
* $Revision: 26486 $
* $Author: rjongbloed $
* $Date: 2011-09-27 17:38:43 +0900 (火, 27 9 2011) $
*/
...
// m_h323_uu_pdu.m_h323_message_body.SetTag(0x63);
...
{ 
  ...
  if (!OpalTransportTCP::Connect())
    return false;
  // PTRACE(1, "initaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
...
// kou add
 ...
 PTRACE(1, "initaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa1111111122222");
  return true;
}
