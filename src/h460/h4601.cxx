...
* $Revision: 25559 $
* $Author: csoutheren $
* $Date: 2011-04-14 09:38:53 +0900 (木, 14 4 2011) $
*/
...
/////////////////////////////////////////////////////////////////////
class H460_FeatureStd18;
class H460_FeatureStd19;
H460_FEATURE(Std18);
H460_FEATURE(Std19);
...
{
  PTRACE(2,"H460\tCreate FeatureSet from FeatureSet PDU");
...
{
      // PTRACE(1,"H460\tPBoolean H460_FeatureSet::LoadFeatureSet(int inst, H323Connection * con)1111");
  if ((ep) && (ep->FeatureSetDisabled()))
    return FALSE;
//      PTRACE(1,"H460\tPBoolean H460_FeatureSet::LoadFeatureSet(int inst, H323Connection * con)2222");
  PStringList features = H460_Feature::GetFeatureNames();
//      PTRACE(1,"H460\tPBoolean H460_FeatureSet::LoadFeatureSet(int inst, H323Connection * con)3333"<<features.GetSize());
...
#if PTRACING
  PTRACE(2,"H460\tFeatureSet for " << PTracePDU(MessageID) << " PDU\n" << fs);
#endif
