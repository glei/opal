...
bool H323Gatekeeper::DiscoverGatekeeper()
{
  ...
  // 2012.04.02 kou add start
  int gateKeeperState = request.Poll(*this, endpoint.GetGatekeeperRequestRetries(), endpoint.GetGatekeeperRequestTimeout());
  if (gateKeeperState == 0)
  {
	stateCon = 1;
  }
  // 2012.04.02 kou add end
...
//  PTRACE(1,"discoveryComplete......"<<discoveryComplete);
...
PBoolean H323Gatekeeper::RegistrationRequest(PBoolean autoReg, PBoolean didGkDiscovery)
{
  ...
  WORD localPort;
  // PTRACE(1, "RAS\tH323Gatekeeper::RegistrationRequest........"<<localPort);  
