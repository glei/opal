 ...
 * $Revision: 26465 $
 * $Author: rjongbloed $
 * $Date: 2011-09-24 12:00:15 +0900 (土, 24 9 2011) $
 */
...
H323EndPoint::H323EndPoint(OpalManager & manager)
  ...
  , disableFastStart(true /*cyoudatu false*/)
  , disableH245Tunneling(true /*cyoudatu false*/)
  ...
  , endSessionTimeout(0, 10)               // Seconds 10->30
  ...
  , roundTripDelayTimeout(0, 10)           // Seconds  10->30
  , roundTripDelayRate(0, 0, 1)            // Minutes  1->2
  , gatekeeperRequestTimeout(0, 5)         // Seconds
  , gatekeeperRequestRetries(2)
  , rasRequestTimeout(0, 50)                // Seconds  3->30
  , rasRequestRetries(2)
...
{
// fprintf(stderr, "hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh:H323EndPoint::MakeConnection\n");
...
{
#if OPAL_H460
    PTRACE(1, "RAS\t555555555555555555555555555");
  return features.SendFeature(id, featureSet);
#else
    PTRACE(1, "RAS\t66666666666666666666666666");
  return false;
#endif
}
