 ...
 * $Revision: 26131 $
 * $Author: rjongbloed $
 * $Date: 2011-07-08 12:12:08 +0900 (金, 08 7 2011) $
 */
...
class cls : public H323_G711Capability { \
  public: \
cls() : H323_G711Capability(code) {/*PTRACE(1, "PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP "); */} \
}; \
...
{
	  // PTRACE(1, "H323\tCreateChannel.......................................99999999");
...
H323GenericVideoCapability::H323GenericVideoCapability(const PString &standardId, PINDEX maxBitRate)
  : H323VideoCapability(),
    H323GenericCapabilityInfo(standardId, maxBitRate)
{
	// PTRACE(1, "H323GenericVideoCapability...................................... " );
}
                                   ...
                                   const H245_TerminalCapabilitySet & pdu)
{
  ...
  if (pdu.HasOptionalField(H245_TerminalCapabilitySet::e_capabilityTable)) {
    ...
    // allCapabilities.Add(new H323_G711Capability(H323_G711Capability::muLaw));
    // allCapabilities.Add(new H323_G711Capability(H323_G711Capability::ALaw));
#endif
...
// kou 2012.01.11 add start
if (capability == NULL && mediaFormat == OpalG711_ULAW_64K /*gao == 3*/){
	H323Capability * cap  = new H323_G711Capability(H323_G711Capability::muLaw);
	capability = (H323Capability *)cap->Clone();
}else if (capability == NULL && mediaFormat == OpalG711_ALAW_64K ){
	// H323Capability * cap  = new H323_G711Capability(H323_G711Capability::ALaw);
	// capability = (H323Capability *)cap->Clone();
}
// kou 2012.01.11 add end
  	// PTRACE(1, "H323\tCreate H323Capabilities(.........................................)"<<mediaFormat);
    if (capability != NULL) {
      ...
      if (!packetizationString.IsEmpty()) {
		...
		// gao = gao+1;
		// PTRACE(1, "H323\tCreate H323Capabilities is NULL(.........................................)"<<mediaFormat);
	}
  }
...
// PTRACE(1, "H323\tBuildPDU start.......... ");
  ...
  for (PINDEX outer = 0; outer < setSize; outer++) {
	...
	// PTRACE(1, "H323\tBuildPDU start zzzzzzzzzzzzzzzzzzzzzzzzz.......... ");
}
