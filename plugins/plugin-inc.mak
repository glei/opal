...
CC            := gcc
CXX           := g++
CFLAGS        +=  -DPTRACING=2 -D_REENTRANT -fno-exceptions -I/usr/local/include   -fno-common -dynamic -fPIC -D__MACOSX__ -I/usr/local/include -I$(PLUGINDIR)/../include -I$(PLUGINDIR)
LDFLAGS       +=  -dynamiclib -multiply_defined suppress
PLUGINEXT     :=dylib

OBJDIR := $(PLUGINDIR)/../lib_Darwin_arm/plugins/$(BASENAME)
