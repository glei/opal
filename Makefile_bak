...
ifeq ($(VERBOSE),)
Q=@
Q_CC = @echo [CC] `echo $< | sed s^/Users/keid/opal/^^` ; 
Q_DEP= @echo [DEP] `echo $< | sed s^/Users/keid/opal/^^` ; 
Q_AR = @echo [AR] `echo $@ | sed s^/Users/keid/opal/^^` ;
Q_LD = @echo [LD] `echo $@ | sed s^/Users/keid/opal/^^` ;
endif
...
SOURCES += $(OPAL_SRCDIR)/opal/manager.cxx \
           ...
           $(OPAL_SRCDIR)/H.263-1998/h263-1998.cxx \
           $(OPAL_SRCDIR)/H.263-1998/rfc2190.cxx \
           $(OPAL_SRCDIR)/H.263-1998/rfc2429.cxx \
           $(OPAL_SRCDIR)/H.263-1998/dyna.cxx \
           $(OPAL_SRCDIR)/H.264/h264-x264.cxx \
           $(OPAL_SRCDIR)/H.264/h264frame.cxx \
           $(OPAL_SRCDIR)/H.264/x264wrap.cxx \
...
LDFLAGS += -enable-auto-import -fatal-warning
endif # mingw
